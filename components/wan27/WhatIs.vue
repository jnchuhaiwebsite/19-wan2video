<template>
  <section id="what-is" class="py-20 lg:py-28 bg-slate-50/50 overflow-hidden">
    <div class="max-w-6xl mx-auto px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 xl:gap-20 items-center">
        
        <!-- Left Content: Typography & Narrative (7 Columns) -->
        <div class="lg:col-span-7">
          ...
          <div class="space-y-6 text-lg text-slate-600 leading-relaxed">
            ...
            <p>
              ...
              artistic textures, and complex camera choreography.
            </p>
          </div>
        </div>
            ...
            <div class="relative bg-white border border-slate-200 p-8 rounded-2xl shadow-2xl shadow-slate-200/60">
              ...
              <div class="space-y-4">
                ...
                <p class="text-slate-600 text-[15px] leading-relaxed">
                  ...
                  integrates advanced physical priors and semantic memory to eliminate character drift.
                </p>
