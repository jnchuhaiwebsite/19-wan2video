<template>
  <div class="min-h-screen bg-blue-pale">
    ...
    <!-- 页面标题 -->
    <PageHero 
      title="wan2.2 7 Image Generator"
      subtitle="
Experience the future of digital art. Transform your text and images into stunning, high-quality visuals with our intuitive wan2.2 image generator, built to harness the full power of wan2.2 V7"
    />
...
// 使用默认的 SEO 配置
  useSeo(
    {
      title: 'wan2.2 7: AI Image Generator for Text & Image Conversion',
      description: 'Experience the future of digital art. Transform your text and images into stunning, high-quality visuals with our intuitive wan2.2 image generator, built to harness the full power of wan2.2 V7'
    }
  )
